    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#f0f8f5] to-[#e4f0ea]">
      ...
      <div className="flex-grow flex flex-col items-center justify-center p-4 pt-8">
        ...
        <div className="bg-gradient-to-r from-[#8FBC8F] to-[#4a8c68] rounded-2xl p-8 max-w-6xl w-full mb-16 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center relative z-10" id='personalizacao'>
        ...
        <div className="max-w-6xl w-full mb-16 bg-white p-8 rounded-2xl shadow-xl border border-[#e0e0e0]" id='trocas'>
          <h2 className="text-2xl md:text-3xl font-bold text-center text-[#4B0082] mb-6">
            Precisa solicitar <span className="text-[#8A2BE2]">troca</span> ou <span className="text-[#8A2BE2]">devolução</span>?
          </h2>
          <p className="text-center text-[#5d7a6d] mb-6 text-lg max-w-2xl mx-auto">
            Fale diretamente com nossa equipe para solicitar sua troca ou devolução de forma rápida e personalizada.
          </p>
          <div className="flex justify-center">
            <a
              href={`https://wa.me/${telefoneVendedora}?text=${encodeURIComponent("Olá, gostaria de solicitar uma *troca* ou *devolução* de um produto comprado.")}`}
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gradient-to-r from-[#8A2BE2] to-[#6A5ACD] text-white px-8 py-4 rounded-xl font-bold hover:from-[#9a3bf0] hover:to-[#7a6ae6] transition-all duration-300 flex items-center shadow-lg transform hover:scale-105"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-6 h-6 mr-2"
